...
class ComboChart(svgwrite.Drawing):
  ...
  INTERACTION_COLOR_MAP = OrderedDict()
  INTERACTION_COLOR_MAP[INTERACTION_SAFE_SYNERGY] =  '#31b149'
  INTERACTION_COLOR_MAP[INTERACTION_SAFE_NO_SYNERGY] =  '#84cf92'
  INTERACTION_COLOR_MAP[INTERACTION_SAFE_DECREASE] =  '#006cb3'
  INTERACTION_COLOR_MAP[INTERACTION_CAUTION] =  '#d5c625'
  INTERACTION_COLOR_MAP[INTERACTION_UNSAFE] =  '#d98427'
  INTERACTION_COLOR_MAP[INTERACTION_DANGEROUS] =  '#d12128'
  INTERACTION_COLOR_MAP[INTERACTION_SEROTONIN_SYNDROME] =  '#684099'
  INTERACTION_COLOR_MAP[INTERACTION_UNKNOWN] =  '#6f6f6f'
